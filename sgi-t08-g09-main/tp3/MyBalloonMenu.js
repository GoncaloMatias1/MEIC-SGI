...
class MyBallonMenu extends THREE.Object3D {
    ...
    createMenuElements() {
        ...
        const startText = this.addMenuItem("SELECT PLAYER", 0, 0, 2);
        ...
        this.startButton.position.set(-13, 6, 0);
    ...
    handleClick(object) {
        if (object.userData.type === 'balloon') {
            ...
            this.onStart({
                playerBalloon: this.selectedBalloon,
            });
        }
    }
